...
class StrategyWrapper {
  /**
     ...
     */
  constructor(strategy, period, signalWeight, params, onLoad) {
    this.inst = require('../' + strategy + '/strategy.js') // import the strategy
...
function setupAlgs() {
  ...
  for(var k in algsEnabled) {
    ...
    if(!(algName in algs)) {
      new StrategyWrapper(algName, algSettings[algName].period, algSettings[algName].weight, algSettings[algName].params, algSettings[algName].onLoad)
    }
  }
