...
module.exports = function() {
  return {
    /**
         ...
         */
    algsEnabled : ['rsi', 'ta_macd', 'trend_ema', 'trust_distrust', 'sar', /*'neural', 'stddev' ,*/ 'speed'],
    ...
    algSettings : {
      ...
      'trust_distrust' : {
        period : 30,
        weight : 100,
        params : ['sell_threshold = 1', /*'sell_threshold_max = 0', 'sell_min = 1', 'buy_threshold = 2',*/ 'buy_threshold_max = 14'/*, 'greed = 0'*/],
        onLoad : null
      },
