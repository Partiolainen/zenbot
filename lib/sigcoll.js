...
module.exports = function container (get, set, clear) {
  return function sigcoll (s, key, url) {
    s.period[key] = { buyprice: null, buyoutdate: null, stoploss: null, target: null,
      buynow: null, sellnow: null,  /*target1: null,*/ price: null }
    ...
    for (var result in results) {
      ...
      if (s.asset === results[result].AssetSymbol) {      
        s.period[key] = { 
          ...
          buynow: results[result].BuyNow,
          sellnow: results[result].SellNow,     
          price: p
         }
        //found = 1
        //break
